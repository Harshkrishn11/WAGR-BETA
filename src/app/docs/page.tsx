...
function TableRow({ col1, col2, col3 }: { col1: string; col2: string; col3: string }) {
  return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 2fr", gap: 16, padding: "16px 0", borderBottom: "1px solid #e5e7eb" }}>
      <div style={{ fontSize: 15, fontWeight: 700, color: "#111827" }}>{col1}</div>
      <div style={{ fontSize: 15, fontFamily: "monospace", color: "#16a34a", fontWeight: 700 }}>{col2}</div>
      <div style={{ fontSize: 14, color: "#6b7280", lineHeight: 1.6 }}>{col3}</div>
    </div>
  );
}
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
        {Icon && <div style={{ padding: 10, borderRadius: 12, background: "rgba(124,58,237,0.1)", border: "1px solid rgba(124,58,237,0.2)" }}><Icon size={24} color="#7C3AED" /></div>}
        <h2 style={{ fontSize: 28, fontWeight: 800, color: "#111827", margin: 0, fontFamily: "var(--font-space-grotesk,sans-serif)", letterSpacing: "-0.02em" }}>{title}</h2>
      </div>
...
export default function DocsPage() {
  return (
    <main style={{ background: "#ffffff", minHeight: "100vh" }}>
      <div style={{ position: "fixed", inset: 0, background: "#ffffff", zIndex: 0, pointerEvents: "none" }}>
        <div style={{ position: "absolute", top: "-10%", left: "50%", transform: "translateX(-50%)", width: 800, height: 600, background: "radial-gradient(circle, rgba(124,58,237,0.05) 0%, transparent 60%)", filter: "blur(60px)" }} />
        <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(#e5e7eb 1px, transparent 1px)", backgroundSize: "32px 32px", opacity: 0.5 }} />
      </div>
      ...
      <div style={{ position: "relative", zIndex: 1, paddingTop: 120, paddingBottom: 80 }}>
        {W(
          <>
            ...
            >
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "8px 16px", borderRadius: 99, background: "rgba(8,145,178,0.1)", border: "1px solid rgba(8,145,178,0.2)", marginBottom: 24 }}>
                <BookOpen size={16} color="#0891B2" />
                <span style={{ fontSize: 12, fontFamily: "monospace", letterSpacing: "0.1em", textTransform: "uppercase", color: "#0891B2", fontWeight: 700 }}>Lite Documentation</span>
              </div>
              <h1 style={{ fontSize: "clamp(3rem, 6vw, 4.5rem)", fontWeight: 900, color: "#111827", margin: "0 0 20px", fontFamily: "var(--font-space-grotesk,sans-serif)", letterSpacing: "-0.03em", lineHeight: 1.1 }}>
                WAGR <span style={{ color: "#7C3AED" }}>Guide</span>
              </h1>
            ...
            <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 32, padding: "40px clamp(20px, 5vw, 60px)", boxShadow: "0 4px 40px rgba(0,0,0,0.03)" }}>
              ...
              <Section title="2. Core Features" icon={Zap} delay={0.2}>
                <div style={{ marginBottom: 32 }}>
                  <h3 style={{ fontSize: 20, color: "#111827", fontWeight: 800, marginBottom: 12, fontFamily: "var(--font-space-grotesk,sans-serif)" }}>Broadcast Pools</h3>
                  <p style={{ margin: 0 }}>
                ...
                <div>
                  <h3 style={{ fontSize: 20, color: "#111827", fontWeight: 800, marginBottom: 12, fontFamily: "var(--font-space-grotesk,sans-serif)" }}>Bet a Friend (P2P)</h3>
                  <p style={{ margin: 0 }}>
              ...
              <Section title="3. Step by Step User Guide" icon={BookOpen} delay={0.3}>
                <ol style={{ paddingLeft: 20, margin: 0, display: "flex", flexDirection: "column", gap: 16 }}>
                  <li><strong style={{ color: "#111827" }}>Connect Your Wallet:</strong> Open the WAGR platform and securely connect your Web3 wallet on the Base network.</li>
                  <li><strong style={{ color: "#111827" }}>Create Your Pool:</strong> Enter your prediction question, set the possible outcomes, and establish the parameters.</li>
                  <li><strong style={{ color: "#111827" }}>Share the Link:</strong> Copy the generated link and paste it into your Twitter thread, Telegram group, or Discord channel.</li>
                  <li><strong style={{ color: "#111827" }}>Claim Your Payout:</strong> Once the event concludes and resolves, winners can instantly claim their funds and creators receive their royalties.</li>
                </ol>
              </Section>
              ...
              <Section title="4. Platform Fees and Economics" delay={0.4}>
                ...
                <div style={{ background: "#f9fafb", borderRadius: 16, padding: "0 24px", border: "1px solid #e5e7eb" }}>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 2fr", gap: 16, padding: "16px 0", borderBottom: "1px solid #e5e7eb", fontSize: 12, textTransform: "uppercase", letterSpacing: "0.1em", color: "#6b7280", fontWeight: 700, fontFamily: "monospace" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 2fr", gap: 16, padding: "16px 0" }}>
                    <div style={{ fontSize: 15, fontWeight: 700, color: "#111827" }}>Protocol Fee</div>
                    <div style={{ fontSize: 15, fontFamily: "monospace", color: "#d97706", fontWeight: 700 }}>1%</div>
                    <div style={{ fontSize: 14, color: "#6b7280", lineHeight: 1.6 }}>Retained by the platform to support ongoing development, maintenance, and server costs.</div>
                  </div>
                </div>
              </Section>
              ...
              <Section title="6. Dispute and Penalty System" icon={Shield} delay={0.6}>
                ...
                <div style={{ marginBottom: 32 }}>
                  <h3 style={{ fontSize: 20, color: "#111827", fontWeight: 800, marginBottom: 12, fontFamily: "var(--font-space-grotesk,sans-serif)" }}>How Disputes Work</h3>
                  <p style={{ margin: 0 }}>
                ...
                <div>
                  <h3 style={{ fontSize: 20, color: "#111827", fontWeight: 800, marginBottom: 16, fontFamily: "var(--font-space-grotesk,sans-serif)" }}>Penalty System</h3>
                  <p style={{ margin: "0 0 24px" }}>
                  ...
                  <div style={{ background: "#f9fafb", borderRadius: 16, padding: "0 24px", border: "1px solid #e5e7eb" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 2fr", gap: 16, padding: "16px 0" }}>
                      <div style={{ fontSize: 15, fontWeight: 700, color: "#111827" }}>Invalid Disputes</div>
                      <div style={{ fontSize: 15, fontFamily: "monospace", color: "#DC2626", fontWeight: 700 }}>Dispute Fee Loss</div>
                      <div style={{ fontSize: 14, color: "#6b7280", lineHeight: 1.6 }}>Users who spam fake disputes lose their initial dispute deposit fee.</div>
                    </div>
                  </div>
                </div>
              </Section>
